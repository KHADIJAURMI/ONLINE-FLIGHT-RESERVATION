    ...
    <body>
        ...
        <header>
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto" id="navli">
                    ...
                    <a class="btn btn-success" href="page/login.php" role="button">User</a>
                    <a class="p-2 m-2 btn btn-success" href="admin/index.php" role="button">Admin</a>
                </div>
            </nav>
        </header>
        ...
        <main role="main">
                                        ...
                                        <form action="index.php" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    $slquery = "SELECT * FROM  `countryticket`" or die("Error: " . mysql_error() . " with query ");
                                            ...
                                            <div class="row">
                                                ...
                                                if (isset($_POST['submit'])) {
                                                    ...
                                                    if (isset($_POST['item']) && isset($_POST['date'])) {
                                                        ...
                                                        $slquery = "SELECT * FROM countryticket WHERE name = '$selected' and date='$date'";
                                                        $selectresult = mysqli_query($conn, $slquery);
                                                        if (mysqli_num_rows($selectresult) != 0) {
            ...
            <footer class="container">
                ...
                <p>&copy; 2017-2018 <a href="https://www.flightslogic.com/flight-reservation-system.php">Flight wEBSITE</a>. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
            </footer>
        </main>
